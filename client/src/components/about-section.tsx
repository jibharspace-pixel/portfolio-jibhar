        ...
        <div className="grid lg:grid-cols-5 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-2 space-y-5">
            ...
            <div className="relative">
              ...
              {/* Overlay badge */}
              <div className="absolute bottom-3 left-3 glass-card rounded-xl px-3 py-2 shadow-lg border border-white/60">
                <div className="flex items-center gap-1.5">
                  <MapPin className="w-3 h-3 text-primary" />
                  <span className="text-xs font-semibold text-foreground">Abidjan, Côte d'Ivoire</span>
                </div>
              </div>
            </div>
